...
I am doing this project to have a depper understanding of the CI/CD precesses.
Also Hand-on provided me with real time experiences simuling the real world scenarions. 
...
1. Clone the repository:
    ```bash
    git clone https://github.com/shabdiana/nextwork-web-project.git
    ```
...
Shabina Shaikh - shaikhshabina2012@gmail.com(mailto:shaikhshabina2012@gmail.com)
